...
actions_static = {
    "POV Blowjob":     "POV deepthroat blowjob, close-up of mouth and a large realistic erect cock, eyes locked on viewer, saliva dripping, explicit oral",
    ...
    "Cowgirl Ride":    "cowgirl straddling and riding a large realistic erect cock, steady bouncing, breasts jiggling, intense gaze",
    "Spread Legs":     "laying back with legs spread wide, pussy wrapped around a realistic erect cock, hands on thighs, direct eye contact",
...
if st.button("Generate"):
    ...
    try:
        ...
        # Determine animation prompt based on preset or custom
        actions_anim = {
            "POV Blowjob": "deepthroat blowjob, gentle suction and head bobbing, natural fellatio motion, she willingly takes the cock fully in then gracefully withdraws",
            "Doggy Style": "doggy style from behind, pelvic thrusts with realistic hip movement, muscle flex, wet skin sheen, slight body sway",
            "Cowgirl Ride": "cowgirl straddling and riding, steady bouncing, natural up-down motion, breasts and thighs movement, subtle torso lean",
            "Spread Legs": "laying back with legs spread wide, rhythmic thigh opening and closing, slight pelvic lifts, direct eye contact",
            "Cum Covered Face": "cum dripping on face in slow motion, messy hair, tongue out, subtle facial expressions of pleasure"
        }
